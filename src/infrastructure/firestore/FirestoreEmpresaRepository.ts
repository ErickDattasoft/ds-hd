...
function toDomain(id: string, d: DocumentData): Empresa {
  return new Empresa({
    ...
    telefonoAlternativo: d.telefonoAlternativo ?? null,
    email: d.email ?? null,
    ...
    contactoAlternativoId: d.contactoAlternativoId ?? null,
    notas: d.notas ?? null,
...
export class FirestoreEmpresaRepository implements IEmpresaRepository {
  ...
  private static toDocument(empresa: Empresa): Record<string, unknown> {
    return {
      ...
      telefonoAlternativo: empresa.telefonoAlternativo,
      email: empresa.email,
      ...
      contactoAlternativoId: empresa.contactoAlternativoId,
      notas: empresa.notas,
