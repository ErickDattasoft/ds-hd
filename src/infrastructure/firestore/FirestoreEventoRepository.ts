...
const eventoToDomain = (id: string, d: DocumentData): Evento =>
  new Evento({
    ...
    contactoWhatsapp: d.contactoWhatsapp ?? null,
    plantilla: d.plantilla ?? null,
    mensajeSeguimiento: d.mensajeSeguimiento ?? null,
    horasSeguimiento: typeof d.horasSeguimiento === 'number' ? d.horasSeguimiento : null,
    ...
    await this.db.collection('eventos').doc(e.id).set(
      {
        ...
        contactoWhatsapp: e.contactoWhatsapp,
        plantilla: e.plantilla,
        mensajeSeguimiento: e.mensajeSeguimiento,
        horasSeguimiento: e.horasSeguimiento,
