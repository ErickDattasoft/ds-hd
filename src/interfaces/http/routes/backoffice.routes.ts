...
export function backofficeRoutes(container: Container): Router {
  ...
  // Manual de uso — visible para cualquier staff, sin permiso especial (es documentación).
  ...
  r.post('/eventos/:id/flayer', requirePermission('eventos:gestionar'), (req, res) => eventos().flayerSubirPost(req, res));
