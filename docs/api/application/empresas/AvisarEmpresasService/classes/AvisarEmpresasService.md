...
> **new AvisarEmpresasService**(`empresas`, `contactos`, `versiones`, `configuracion`, `email`, `gateway`, `bitacora`, `clock`, `avisos`, `ids`, `usuarios?`): `AvisarEmpresasService`
...
[`IAvisoRepository`](../../../../core/ports/repositories/IAvisoRepository/interfaces/IAvisoRepository.md)
